...
#' @export
xCell2Train <- function(ref, labels, mix = NULL, ref_type, mix_type = NULL, QN = TRUE, lineage_file = NULL, top_genes_frac = 1, medianGEP = TRUE, seed = 123, probs = c(0.01, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.49),
