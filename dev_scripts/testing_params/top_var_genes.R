############################################################
# Using top varible genes for sc helps?
############################################################
...
useTopVar <- TRUE
nTopVar <- 5000
top5kvar_res <- mclapply(1:nrow(vals.refs.res), function(i) {
...
useTopVar <- TRUE
nTopVar <- 3000
top3kvar_res <- mclapply(1:nrow(vals.refs.res), function(i) {
...
useTopVar <- TRUE
nTopVar <- 10000
top10kvar_res <- mclapply(1:nrow(vals.refs.res), function(i) {
...
useTopVar <- FALSE
novar_res <- mclapply(1:nrow(vals.refs.res), function(i) {
