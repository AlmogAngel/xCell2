...
weight_genes <- TRUE
res_weights <- mclapply(1:nrow(vals.refs.res), function(i) {
...
weight_genes <- FALSE
res_noweights <- mclapply(1:nrow(vals.refs.res), function(i) {
...
results <- list(res_weights, res_noweights)
...
saveRDS(allcors, "/bigdata/almogangel/xCell2/dev_scripts/testing_params/genes_weights_allcors_cyto.rds")
